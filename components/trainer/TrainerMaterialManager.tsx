            ...
            <div key={material.id} className="bg-white border border-slate-200 rounded-2xl shadow-sm p-5 flex flex-col justify-between transition-shadow hover:shadow-lg">
                <div className="flex flex-col flex-grow">
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-200 flex items-center gap-2">
                        <button onClick={() => handleViewMaterial(material)} className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium text-center text-violet-700 bg-violet-100 rounded-lg hover:bg-violet-200">
                            <EyeIcon className="w-4 h-4" />
                            View
                        </button>
                        <button onClick={() => handleGenerate(material, AssessmentType.TEST)} disabled={material.type === MaterialType.VIDEO} className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium text-center text-white bg-sky-600 rounded-lg hover:bg-sky-700 disabled:bg-slate-400 disabled:cursor-not-allowed">
                            <GenerateIcon className="w-4 h-4" />
                            Test
                        </button>
                        <button onClick={() => handleGenerate(material, AssessmentType.ASSIGNMENT)} disabled={material.type === MaterialType.VIDEO} className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium text-center text-white bg-amber-600 rounded-lg hover:bg-amber-700 disabled:bg-slate-400 disabled:cursor-not-allowed">
                            <GenerateIcon className="w-4 h-4" />
                            Assignment
                        </button>
                    </div>
