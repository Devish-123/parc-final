    ...
    <div>
        <div className="flex justify-between items-center">
            <div>
                ...
                <p className="mt-2 text-violet-600 dark:text-violet-400">Select a college to view its detailed training dashboard.</p>
            </div>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {colleges.map((college) => (
              <button
                ...
                className="p-5 bg-gradient-to-br from-parc-blue-medium to-parc-blue-dark rounded-xl shadow-lg border-slate-700/50 text-left transition-all duration-300 transform hover:shadow-xl hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500 dark:focus:ring-offset-slate-900"
              >
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-300 line-clamp-1">{college.address || 'No address'}</p>
                    </div>
                </div>
              </button>
            ))}
