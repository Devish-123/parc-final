...
// FIX: Changed to named import for TrainerDashboard to fix module resolution error.
import { TrainerDashboard } from './components/trainer/TrainerDashboard';
// FIX: Changed to named import for StudentDashboard to fix module resolution error.
import { StudentDashboard } from './components/student/StudentDashboard';
import { Role } from './types';
import RoleSwitcher from './components/shared/RoleSwitcher';
import { PygenicArcTextLogo } from './components/icons/Icons';
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-screen main-bg text-slate-200">
                <div className="text-center p-8 bg-slate-900/50 backdrop-blur-sm rounded-2xl border border-slate-700">
                    <PygenicArcTextLogo className="mx-auto h-16 w-auto text-violet-500" />
